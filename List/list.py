...
Places = ['Asia', 'Europe']
Places2 = ['Oceania', 'America']

# Insert inseri o valor num index especifico, (index, valor)
Places2.insert(1, 'Africa')

# Extend é basicamente: Place recebe valores de Place2
